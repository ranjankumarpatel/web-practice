...
public class LoginBinder implements HttpSessionBindingListener,HttpSessionListener
	...
	private static Map<LoginBinder, HttpSession> logins = new HashMap<LoginBinder, HttpSession>();
	...
	public void sessionDestroyed(HttpSessionEvent event) {
		...
		long expirydate = session.getLastAccessedTime()+session.getMaxInactiveInterval()*1000;
		...
		System.out.println("cur date"+curdate+"exp date"+expirydate+"expirydate<curdate"+ (expirydate<curdate));
	 ...
	 * @return the logins
	 */
	public static Map<LoginBinder, HttpSession> getLogins() {
		return logins;
	}
